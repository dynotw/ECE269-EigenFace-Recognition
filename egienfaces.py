...
# load new faceimages, and use eigenvector to build new faceimage with weight
    new_faceimage = createNewFace(mean, 'car.jpg', num_eigenfaces, eigenVectors)
...
# show the new_faceimage with weight
    ...
    cv2.imwrite(r'C:\Users\83414\Desktop\ECE 269\Project\1a_rotated_f.jpg',new_faceimage.reshape(sz)*255)
